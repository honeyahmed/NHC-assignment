...
export default function NotFound() {
  return (
    <div className='flex flex-col items-center justify-center min-h-[calc(100vh-100px)] px-2'>
        <Image src="/not-found.png" alt="Not found" width={200} height={250} />
        <h2 className='text-2xl font-semibold text-nhc-blue mb-4 mt-4'>Product Not Found</h2>
